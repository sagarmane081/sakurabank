...
class TransferDeadlockTest {
    ...
    @Test
    void simultaneousOppositeDirectionTransfersDoNotDeadlock()
            throws Exception {
        ...
        User alice = userRepository.save(
                new User(
                        "alice-deadlock-" + UUID.randomUUID(),
